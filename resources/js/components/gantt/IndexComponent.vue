            ...
            for(let j = 0; j< this.campania_etapas.length; j++){
                if(this.campania_etapas[j].campania_id == this.campanias[i].id){
                    ...
                    for(let k = 0; k < this.entregables.length; k++){
                        ...
                        console.log(this.campanias[i].id == this.entregables[k].campania_id &&
                        this.campania_etapas[j].etapa_id == this.entregables[k].etapa_id);
                        if(
                        this.campanias[i].id == this.entregables[k].campania_id &&
                        this.campania_etapas[j].etapa_id == this.entregables[k].etapa_id
                        ){
                            for(let l = 0; l < this.actividades.length; l++){
                                if(
                                    this.campanias[i].id == this.actividades[l].campania_id &&
