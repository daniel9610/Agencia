...
<div class="container">
    <h1>Generar investigación de brief</h1>
                    ...
                    <div class="accordion" id="accordionExample">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
                                <div class="card-body">
                                    <a href="{{ URL::route('finalizarinvestigacionbrief', $campania_id) }}" class="btn btn-primary btn-lg btn-block">Finalizar KickOff</a>
                                </div>
                            </div>
                        </div>
                    </div>
